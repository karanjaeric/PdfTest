...
public class NewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            OutputStream file = new FileOutputStream(new File("karanja.pdf"));
            ...
            String amountInWords = UtilityA.convert(Integer.parseInt(request.getParameter("amount")));

            Paragraph p1 = new Paragraph("No:              " + "Ann Mumbi Karanja LTD          " + "Date: "+new Date().toString());
            ...
            Paragraph p6 = new Paragraph("Shs.  " + request.getParameter("amount")+"/=");
            document.add(p1);
            document.add(p2);
            document.add(p3);
            document.add(p4);
